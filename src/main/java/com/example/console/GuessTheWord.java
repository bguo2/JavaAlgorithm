...
//
//You may call Master.guess(word) to guess a word. The guessed word should have type string and must be from the original list
...
//
//For each test case, you have exactly 10 guesses to guess the word. At the end of any number of calls, if you have made 10
...
public class GuessTheWord {
    ...
    public void findSecretWord(String[] wordlist, Master master) {
        ...
        for (int i=0; i<10; i++) {
            ...
            if (matches == 6) return;
            words = filterWords(words, guessWord, matches == -1 ? 0:matches);
        }
    }
